...
/*
 Ecnontrei Duas Soluções Para Esse Mesmo Desafio
Segue A segunda
 */
...
using System;
    ...
    class Bazinga
    {
        static void Main(string[] args)
        {
            ...
            int vQuantidadeFor = int.Parse(Console.ReadLine());
            string v1, v2;

            for (int i = 1; i <= vQuantidadeFor; i++)
            {
                ...
                else if (v1 == "papel" & v2 == "pedra")
                {
                    Console.WriteLine("Caso #" + i + ": Bazinga!");
                }
                else if (v1 == "pedra" & v2 == "lagarto")
                {
                    Console.WriteLine("Caso #" + i + ": Bazinga!");
                }
                else if (v1 == "lagarto" & v2 == "Spock")
                {
                    Console.WriteLine("Caso #" + i + ": Bazinga!");
                }
                else if (v1 == "Spock" & v2 == "tesoura")
                {
                    Console.WriteLine("Caso #" + i + ": Bazinga!");
                }
                else if (v1 == "tesoura" & v2 == "lagarto")
                {
                    Console.WriteLine("Caso #" + i + ": Bazinga!");
                }
                else if (v1 == "lagarto" & v2 == "papel")
                {
                    Console.WriteLine("Caso #" + i + ": Bazinga!");
                }
                else if (v1 == "papel" & v2 == "Spock")
                {
                    Console.WriteLine("Caso #" + i + ": Bazinga!");
                }
                else if (v1 == "Spock" & v2 == "pedra")
                {
                    Console.WriteLine("Caso #" + i + ": Bazinga!");
                }
                else if (v1 == "pedra" & v2 == "tesoura")
                {
                    Console.WriteLine("Caso #" + i + ": Bazinga!");
                }
                else if (v1 == "Spock" & v2 == "papel")
                {
                    Console.WriteLine("Caso #" + i + ": Raj trapaceou!");
                }
                else if (v2 == "tesoura" & v1 == "papel")
                {
                    Console.WriteLine("Caso #" + i + ": Raj trapaceou!");
                }
                else if (v2 == "papel" & v1 == "pedra")
                {
                    Console.WriteLine("Caso #" + i + ": Raj trapaceou!");
                }
                else if (v2 == "pedra" & v1 == "lagarto")
                {
                    Console.WriteLine("Caso #" + i + ": Raj trapaceou!");
                }
                else if (v2 == "lagarto" & v1 == "Spock")
                {
                    Console.WriteLine("Caso #" + i + ": Raj trapaceou!");                
                }
                else if (v2 == "Spock" & v1 == "tesoura")
                {
                    Console.WriteLine("Caso #" + i + ": Raj trapaceou!"); 
                }
                else if (v2 == "tesoura" & v1 == "lagarto")
                {
                    Console.WriteLine("Caso #" + i + ": Raj trapaceou!");
                }
                else if (v2 == "lagarto" & v1 == "papel")
                {
                    Console.WriteLine("Caso #" + i + ": Raj trapaceou!");
                }
                else if (v2 == "papel" & v1 == "Spock")
                {
                    Console.WriteLine("Caso #" + i + ": Raj trapaceou!");
                }
                else if (v2 == "Spock" & v1 == "pedra")
                {
                    Console.WriteLine("Caso #" + i + ": Raj trapaceou!");
                }
                else if (v2 == "pedra" & v1 == "tesoura")
                {
                    Console.WriteLine("Caso #" + i + ": Raj trapaceou!");
                }
                else if (v1 == v2)
